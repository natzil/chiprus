(function(){
  ...
  function renderAreas(){
    ...
    const areas = [
      ...
      { name:'Хобби', level:'0%', accent:'#c9895b', pct:hobbyPct, subs:[['NAS', projectPercent('NAS')], ['Лаборатория', 0]] },
      { name:'Здоровье', level:'week', accent:'#8ccf7e', pct:0, subs:[['Бассейн', 0], ['Ходьба', 0], ['Сон', 0]] },
      { name:'Бизнес', level:'plan', accent:'#d7b56d', pct:0, subs:[['Клиенты', 0], ['Контент', 0], ['Финансы', 0]] }
    ];
