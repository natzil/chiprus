(function(){
  ...
  window.APP_STATE = {
    ...
    projects: [
      { id:'nas', name:'NAS / домашний сервер', description:'Домашнее хранилище и сервисы', area:'hobby', status:'active', importance:'средняя', difficulty:'средняя', target_xp:500, current_stage:'0% · старт без выполненных задач', created_at:yesterday }
    ],
    projectTasks: [
      { id:'nas-1', project_id:'nas', title:'Выбрать ОС для сервера', description:'TrueNAS / Debian / Unraid', xp:60, status:'active', created_at:yesterday }
    ],
